...
export default function TurnOnContract(props:Props){
  ...
  async function transfer(event:React.FormEvent) {
    ...
    erc20.initialize(parseEther(amount)).catch('error', console.error)
  }
    ...
    <div>
        <form onSubmit={transfer}>
          ...
          <FormLabel htmlFor='amount'>Amount: </FormLabel>
            ...
            <Button type="submit" isDisabled={!account}>Initialize</Button>
          </FormControl>
        </form>
    </div>
  )
